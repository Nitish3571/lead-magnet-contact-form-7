...
class CFDB7_Wp_Main_Page
{
    ...
    public function admin_list_table_page()
    {
        ...
        add_menu_page( __( 'Lead Magnet List', 'contact-form-cfdb7' ), __( 'Lead Magnet List', 'contact-form-cfdb7' ), $cfdb7_cap, 'cfdb7-list.php', array($this, 'list_table_page'), 'dashicons-list-view' );
